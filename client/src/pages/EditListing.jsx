    ...
    <main className="pt-8 p-3 max-w-4xl mx-auto min-h-screen ">
      ...
      <form className="flex flex-col sm:flex-row px-4 text-xs sm:text-sm gap-4">
        ...
        <div className="flex flex-col flex-1 gap-2">
          ...
          <button
            className="uppercase font-bold p-3 bg-red-700 hover:opacity-80 text-white w-full self-center transition duration-300 ease-in-out transform hover:scale-105 mt-4"
